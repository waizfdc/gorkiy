    ...
    public synchronized Settings initialize(Kit kit, IdManager idManager, HttpRequestFactory httpRequestFactory, String str, String str2, String str3, DataCollectionArbiter dataCollectionArbiter) {
        ...
        synchronized (this) {
            ...
            if (this.settingsController == null) {
                ...
                String str4 = str3;
                DefaultSettingsSpiCall defaultSettingsSpiCall = new DefaultSettingsSpiCall(kit2, str4, String.format(Locale.US, SETTINGS_URL_FORMAT, appIdentifier), httpRequestFactory);
                String modelName = idManager.getModelName();
                String str5 = modelName;
                String str6 = str2;
                String str7 = str;
                Kit kit3 = kit;
                this.settingsController = new DefaultSettingsController(kit3, new SettingsRequest(value, str5, idManager.getOsBuildVersionString(), idManager.getOsDisplayVersionString(), idManager.getAppInstallIdentifier(), CommonUtils.createInstanceIdFrom(CommonUtils.resolveBuildId(context)), str6, str7, DeliveryMechanism.determineFrom(installerPackageName).getId(), appIconHashOrNull), systemCurrentTimeProvider, defaultSettingsJsonTransform, defaultCachedSettingsIo, defaultSettingsSpiCall, dataCollectionArbiter);
            }
