...
class PinningTrustManager implements X509TrustManager {
    ...
    private void checkPinTrust(X509Certificate[] x509CertificateArr) throws CertificateException {
        ...
        logger.w(Fabric.TAG, "Certificate pins are stale, (" + (System.currentTimeMillis() - this.pinCreationTimeMillis) + " millis vs " + ((long) PIN_FRESHNESS_DURATION_MILLIS) + " millis) falling back to system trust.");
    }
