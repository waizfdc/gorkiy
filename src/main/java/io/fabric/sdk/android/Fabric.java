...
public class Fabric {
    ...
    public static class Builder {
        ...
        public Fabric build() {
            ...
            return new Fabric(applicationContext, map2, this.threadPoolExecutor, this.handler, this.logger, this.debuggable, this.initializationCallback, new IdManager(applicationContext, this.appIdentifier, this.appInstallIdentifier, map2.values()), Fabric.extractActivity(this.context));
        }
    }
    ...
    private void init() {
        ActivityLifecycleManager activityLifecycleManager2 = new ActivityLifecycleManager(this.context);
        this.activityLifecycleManager = activityLifecycleManager2;
        activityLifecycleManager2.registerCallbacks(new ActivityLifecycleManager.Callbacks() {
