...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public static <T, R> io.reactivex.Flowable<R> combineLatest(java.lang.Iterable<? extends org.reactivestreams.Publisher<? extends T>> r1, io.reactivex.functions.Function<? super java.lang.Object[], ? extends R> r2) {
        /*
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.combineLatest(java.lang.Iterable, io.reactivex.functions.Function):io.reactivex.Flowable");
    }
    ...
    public static <T, R> io.reactivex.Flowable<R> combineLatestDelayError(java.lang.Iterable<? extends org.reactivestreams.Publisher<? extends T>> r1, io.reactivex.functions.Function<? super java.lang.Object[], ? extends R> r2) {
        /*
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.combineLatestDelayError(java.lang.Iterable, io.reactivex.functions.Function):io.reactivex.Flowable");
    }
    ...
    public static <T, S> io.reactivex.Flowable<T> generate(java.util.concurrent.Callable<S> r1, io.reactivex.functions.BiConsumer<S, io.reactivex.Emitter<T>> r2, io.reactivex.functions.Consumer<? super S> r3) {
        /*
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.generate(java.util.concurrent.Callable, io.reactivex.functions.BiConsumer, io.reactivex.functions.Consumer):io.reactivex.Flowable");
    }
    ...
    public static Flowable<Long> intervalRange(long j, long j2, long j3, long j4, TimeUnit timeUnit, Scheduler scheduler) {
        ...
        if (i < 0) {
            ...
            if (j <= 0 || j7 >= 0) {
                ...
                return RxJavaPlugins.onAssembly(new FlowableIntervalRange(j, j7, Math.max(0L, j6), Math.max(0L, j4), timeUnit, scheduler));
            }
    ...
    public static <T, D> io.reactivex.Flowable<T> using(java.util.concurrent.Callable<? extends D> r1, io.reactivex.functions.Function<? super D, ? extends org.reactivestreams.Publisher<? extends T>> r2, io.reactivex.functions.Consumer<? super D> r3) {
        /*
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.using(java.util.concurrent.Callable, io.reactivex.functions.Function, io.reactivex.functions.Consumer):io.reactivex.Flowable");
    }
    ...
    public final <K> io.reactivex.Flowable<io.reactivex.flowables.GroupedFlowable<K, T>> groupBy(io.reactivex.functions.Function<? super T, ? extends K> r4) {
        /*
            ...
            int r1 = bufferSize()
            r2 = 0
            io.reactivex.Flowable r4 = r3.groupBy(r4, r0, r2, r1)
            return r4
        */
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public <R> io.reactivex.Flowable<R> switchMap0(io.reactivex.functions.Function<? super T, ? extends org.reactivestreams.Publisher<? extends R>> r2, int r3, boolean r4) {
        /*
            r1 = this;
            java.lang.String r0 = "mapper is null"
            io.reactivex.internal.functions.ObjectHelper.requireNonNull(r2, r0)
    ...
    public final <K, V> io.reactivex.Single<java.util.Map<K, java.util.Collection<V>>> toMultimap(io.reactivex.functions.Function<? super T, ? extends K> r2, io.reactivex.functions.Function<? super T, ? extends V> r3, java.util.concurrent.Callable<java.util.Map<K, java.util.Collection<V>>> r4) {
        /*
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.toMultimap(io.reactivex.functions.Function, io.reactivex.functions.Function, java.util.concurrent.Callable):io.reactivex.Single");
    }
    ...
    public final <U, R> io.reactivex.Flowable<R> zipWith(org.reactivestreams.Publisher<? extends U> r2, io.reactivex.functions.BiFunction<? super T, ? super U, ? extends R> r3) {
        /*
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.zipWith(org.reactivestreams.Publisher, io.reactivex.functions.BiFunction):io.reactivex.Flowable");
    }
    ...
    public final <U, R> io.reactivex.Flowable<R> zipWith(org.reactivestreams.Publisher<? extends U> r1, io.reactivex.functions.BiFunction<? super T, ? super U, ? extends R> r2, boolean r3) {
        /*
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.zipWith(org.reactivestreams.Publisher, io.reactivex.functions.BiFunction, boolean):io.reactivex.Flowable");
    }
    ...
    public final <U, R> io.reactivex.Flowable<R> zipWith(org.reactivestreams.Publisher<? extends U> r1, io.reactivex.functions.BiFunction<? super T, ? super U, ? extends R> r2, boolean r3, int r4) {
        /*
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.Flowable.zipWith(org.reactivestreams.Publisher, io.reactivex.functions.BiFunction, boolean, int):io.reactivex.Flowable");
    }
