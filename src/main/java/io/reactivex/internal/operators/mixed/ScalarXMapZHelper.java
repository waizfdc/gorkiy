...
final class ScalarXMapZHelper {
    ...
    static <T> boolean tryAsCompletable(java.lang.Object r2, io.reactivex.functions.Function<? super T, ? extends io.reactivex.CompletableSource> r3, io.reactivex.CompletableObserver r4) {
        /*
            ...
            java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r2, r3)     // Catch:{ all -> 0x0025 }
            r0 = r2
            io.reactivex.CompletableSource r0 = (io.reactivex.CompletableSource) r0     // Catch:{ all -> 0x0025 }
        L_0x001b:
            if (r0 != 0) goto L_0x0021
            io.reactivex.internal.disposables.EmptyDisposable.complete(r4)
            goto L_0x0024
        L_0x0021:
            r0.subscribe(r4)
        L_0x0024:
        ...
        L_0x0025:
            ...
            io.reactivex.internal.disposables.EmptyDisposable.error(r2, r4)
            return r1
        L_0x002d:
            r2 = 0
            return r2
    ...
    static <T, R> boolean tryAsMaybe(java.lang.Object r2, io.reactivex.functions.Function<? super T, ? extends io.reactivex.MaybeSource<? extends R>> r3, io.reactivex.Observer<? super R> r4) {
        /*
            ...
            java.lang.Object r2 = io.reactivex.internal.functions.ObjectHelper.requireNonNull(r2, r3)     // Catch:{ all -> 0x0029 }
            r0 = r2
