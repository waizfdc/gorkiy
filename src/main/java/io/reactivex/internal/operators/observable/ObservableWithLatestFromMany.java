...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    public ObservableWithLatestFromMany(ObservableSource observableSource, Iterable<? extends ObservableSource<?>> iterable, Function function) {
        super(observableSource);
    ...
    static final class WithLatestFromObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            if (!this.done) {
                ...
                try {
                    HalfSerializer.onNext(this.downstream, ObjectHelper.requireNonNull(this.combiner.apply(objArr), "combiner returned a null value"), super, this.error);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    dispose();
                    onError(th);
    ...
    static final class WithLatestInnerObserver extends AtomicReference<Disposable> implements Observer<Object> {
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(super, disposable);
        }
        ...
        public void dispose() {
            DisposableHelper.dispose(super);
        }
    }
