...
public final class zzh extends zzb implements IBarcodeDetector {
    zzh(IBinder iBinder) {
    ...
    public final IObjectWrapper zzb(IObjectWrapper iObjectWrapper, zzrk zzrk) throws RemoteException {
