...
final class zzaf implements ServiceConnection {
    ...
    private zzaf(zzad zzad) {
        this.zzf = zzad;
        this.zza = 0;
        this.zzb = new Messenger(new zze(Looper.getMainLooper(), new zzae(this)));
    ...
    public final synchronized boolean zza(com.google.firebase.iid.zzam<?> r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x002e:
            ...
            return r2
        L_0x0030:
            java.util.Queue<com.google.firebase.iid.zzam<?>> r0 = r5.zzd     // Catch:{ all -> 0x0097 }
        ...
        L_0x005f:
            ...
            com.google.firebase.iid.zzad r1 = r5.zzf     // Catch:{ all -> 0x0097 }
            ...
            goto L_0x0095
        L_0x0083:
            com.google.firebase.iid.zzad r6 = r5.zzf     // Catch:{ all -> 0x0097 }
            java.util.concurrent.ScheduledExecutorService r6 = r6.zzc     // Catch:{ all -> 0x0097 }
            com.google.firebase.iid.zzah r0 = new com.google.firebase.iid.zzah     // Catch:{ all -> 0x0097 }
        ...
        L_0x0097:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.zzaf.zza(com.google.firebase.iid.zzam):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x005f, code lost:
        r1.zza(new com.google.firebase.iid.zzap(4, "Not supported by GmsCore"));
     */
    ...
    public final boolean zza(android.os.Message r5) {
        ...
        L_0x0023:
            monitor-enter(r4)
            android.util.SparseArray<com.google.firebase.iid.zzam<?>> r1 = r4.zze     // Catch:{ all -> 0x006f }
            java.lang.Object r1 = r1.get(r0)     // Catch:{ all -> 0x006f }
            com.google.firebase.iid.zzam r1 = (com.google.firebase.iid.zzam) r1     // Catch:{ all -> 0x006f }
            r2 = 1
            ...
            return r2
        L_0x0049:
            android.util.SparseArray<com.google.firebase.iid.zzam<?>> r3 = r4.zze     // Catch:{ all -> 0x006f }
        ...
        L_0x006f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.zzaf.zza(android.os.Message):boolean");
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        this.zzf.zzc.execute(new zzag(this, iBinder));
    }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        this.zzf.zzc.execute(new zzai(this));
    }
    ...
    public final synchronized void zza(int i, String str) {
        ...
        if (i2 == 0) {
            ...
            zzap zzap = new zzap(i, str);
            for (zzam<?> zza2 : this.zzd) {
                zza2.zza(zzap);
            }
            this.zzd.clear();
            for (int i3 = 0; i3 < this.zze.size(); i3++) {
                this.zze.valueAt(i3).zza(zzap);
            }
            this.zze.clear();
        } else if (i2 == 3) {
            this.zza = 4;
    ...
    public final synchronized void zza(int i) {
        ...
        if (zzam != null) {
            ...
            this.zze.remove(i);
            zzam.zza(new zzap(3, "Timed out waiting for response"));
            zzb();
        }
    }
}
