...
public final class zzbj implements ServiceConnection {
    ...
    public final synchronized Task<Void> zza(Intent intent) {
        ...
        zzbi = new zzbi(intent);
        ScheduledExecutorService scheduledExecutorService = this.zzc;
        zzbi.zza().addOnCompleteListener(scheduledExecutorService, new zzbk(scheduledExecutorService.schedule(new zzbl(zzbi), 9000, TimeUnit.MILLISECONDS)));
        this.zzd.add(zzbi);
        zza();
        return zzbi.zza();
    }
    ...
    private final synchronized void zza() {
        ...
        L_0x0011:
            java.util.Queue<com.google.firebase.iid.zzbi> r0 = r6.zzd     // Catch:{ all -> 0x00ab }
            ...
            android.util.Log.d(r0, r2)     // Catch:{ all -> 0x00ab }
        L_0x0028:
            com.google.firebase.iid.zzbe r0 = r6.zze     // Catch:{ all -> 0x00ab }
        ...
        L_0x0043:
            ...
            com.google.firebase.iid.zzbi r0 = (com.google.firebase.iid.zzbi) r0     // Catch:{ all -> 0x00ab }
            com.google.firebase.iid.zzbe r2 = r6.zze     // Catch:{ all -> 0x00ab }
        ...
        L_0x00ab:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.zzbj.zza():void");
    }
