...
public class FirebaseInstanceId {
        ...
        private final synchronized void zzb() {
            if (!this.zzd) {
                ...
                if (zzc2 == null && this.zzb) {
                    zzr zzr = new zzr(this);
                    this.zze = zzr;
                    this.zzc.subscribe(DataCollectionDefaultChange.class, zzr);
                }
                this.zzd = true;
            }
        }
    ...
    private FirebaseInstanceId(FirebaseApp firebaseApp, zzaq zzaq, Executor executor, Executor executor2, Subscriber subscriber, UserAgentPublisher userAgentPublisher, HeartBeatInfo heartBeatInfo, FirebaseInstallationsApi firebaseInstallationsApi) {
        ...
        if (zzaq.zza(firebaseApp) != null) {
            ...
            this.zzf = zzaq;
            this.zzg = new zzs(firebaseApp, zzaq, executor, userAgentPublisher, heartBeatInfo, firebaseInstallationsApi);
            this.zzd = executor3;
    ...
    private static void zza(FirebaseApp firebaseApp) {
        ...
        if (TextUtils.isEmpty(firebaseApp.getOptions().getProjectId())) {
            str = firebaseApp.getOptions().getGcmSenderId();
        } else {
            str = firebaseApp.getOptions().getProjectId();
        }
    ...
    private final String zzl() {
        try {
            ...
            id.addOnCompleteListener(zzm.zza, new zzp(countDownLatch));
    ...
    private final Task<InstanceIdResult> zza(String str, String str2) {
        return Tasks.forResult(null).continueWithTask(this.zzd, new zzn(this, str, zzd(str2)));
    }
    ...
    /* access modifiers changed from: package-private */
    public final boolean zza(zzbb zzbb) {
        return zzbb == null || zzbb.zzb(this.zzf.zzb());
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ Task zza(String str, String str2, Task task) throws Exception {
        String zzl2 = zzl();
        zzbb zzb2 = zzb(str, str2);
        if (!zza(zzb2)) {
            return Tasks.forResult(new zzab(zzl2, zzb2.zza));
        }
        return this.zzh.zza(str, str2, new zzo(this, zzl2, str, str2));
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ Task zza(String str, String str2, String str3) {
        return this.zzg.zza(str, str2, str3).onSuccessTask(this.zzd, new zzq(this, str2, str3, str));
    }
