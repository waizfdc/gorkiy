...
final class zzi extends zzt {
    ...
    public boolean equals(Object obj) {
        ...
        zzt zzt = (zzt) obj;
        if (this.zza == super.zza()) {
            zzi zzi = (zzi) zzt;
            if (this.zzb == zzi.zzb && this.zzc == super.zzb()) {
                byte[] bArr2 = this.zzd;
                ...
                if (Arrays.equals(bArr2, bArr) && ((str = this.zze) != null ? str.equals(zzi.zze) : zzi.zze == null) && this.zzf == super.zzc()) {
                    zzy zzy = this.zzg;
                    if (zzy == null) {
                        if (zzi.zzg == null) {
                            return true;
