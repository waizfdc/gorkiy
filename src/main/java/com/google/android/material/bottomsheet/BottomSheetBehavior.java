    ...
    private void updateAccessibilityActions() {
        ...
        if (weakReference != null && (view = (View) weakReference.get()) != null) {
            ...
            if (i == 3) {
                ...
                addAccessibilityActionForState(view, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_COLLAPSE, c);
            } else if (i == 4) {
                if (this.fitToContents) {
                    c = 3;
                }
                addAccessibilityActionForState(view, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_EXPAND, c);
            } else if (i == 6) {
