...
public final class CollapsingTextHelper {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: androidx.core.math.MathUtils.clamp(float, float, float):float
     arg types: [float, int, int]
     candidates:
      androidx.core.math.MathUtils.clamp(double, double, double):double
      androidx.core.math.MathUtils.clamp(int, int, int):int
      androidx.core.math.MathUtils.clamp(long, long, long):long
      androidx.core.math.MathUtils.clamp(float, float, float):float */
