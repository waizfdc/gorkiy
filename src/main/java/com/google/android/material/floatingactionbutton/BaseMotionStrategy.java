...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(SettingsJsonConstants.ICON_WIDTH_KEY)) {
            arrayList.add(motionSpec2.getAnimator(SettingsJsonConstants.ICON_WIDTH_KEY, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec2.hasPropertyValues(SettingsJsonConstants.ICON_HEIGHT_KEY)) {
            arrayList.add(motionSpec2.getAnimator(SettingsJsonConstants.ICON_HEIGHT_KEY, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
