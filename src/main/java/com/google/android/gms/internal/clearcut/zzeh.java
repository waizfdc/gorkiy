...
final class zzeh {
    ...
    private static <UT, UB> UB zza(int i, int i2, Object obj, zzex zzex) {
        if (obj == null) {
            obj = zzex.zzdz();
        }
        zzex.zza(obj, i, (long) i2);
        return obj;
    }
    ...
    static <T> void zza(zzdj zzdj, Object obj, Object obj2, long j) {
        zzfd.zza(obj, j, zzdj.zzb(zzfd.zzo(obj, j), zzfd.zzo(obj2, j)));
    }
