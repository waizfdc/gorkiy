...
public final class zzju extends zzjv {
    private static final char[] zzagd = {'+'};
    private static final char[] zzage = "0123456789ABCDEF".toCharArray();
    ...
    public zzju(String str, boolean z) {
