    ...
    public final void removeAllListeners() throws RemoteException {
        synchronized (this.zzcx) {
            for (zzax next : this.zzcx.values()) {
                if (next != null) {
                    this.zzcb.getService().zza(zzbf.zza(next, (zzaj) null));
                }
            }
            this.zzcx.clear();
        }
        synchronized (this.zzcz) {
            for (zzat next2 : this.zzcz.values()) {
                if (next2 != null) {
                    this.zzcb.getService().zza(zzbf.zza(next2, (zzaj) null));
                }
            }
            this.zzcz.clear();
        }
        synchronized (this.zzcy) {
            for (zzaw next3 : this.zzcy.values()) {
                if (next3 != null) {
                    this.zzcb.getService().zza(new zzo(2, null, next3.asBinder(), null));
                }
            }
            this.zzcy.clear();
        }
