...
final class zzdq {
    ...
    static int zza(zzhd<?> zzhd, int i, byte[] bArr, int i2, int i3, zzfl<?> zzfl, zzdt zzdt) throws IOException {
        int zza = zza(zzhd, bArr, i2, i3, zzdt);
        zzfl.add(zzdt.zzc);
        while (zza < i3) {
            int zza2 = zza(bArr, zza, zzdt);
            if (i != zzdt.zza) {
            ...
            zza = zza(zzhd, bArr, zza2, i3, zzdt);
            zzfl.add(zzdt.zzc);
        }
        return zza;
    }
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzhy zzhy, zzdt zzdt) throws zzfo {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                ...
                zzhy.zza(i, Long.valueOf(zzdt.zzb));
                return zzb;
            } else if (i4 == 1) {
                zzhy.zza(i, Long.valueOf(zzb(bArr, i2)));
                return i2 + 8;
            } else if (i4 == 2) {
                int zza = zza(bArr, i2, zzdt);
                int i5 = zzdt.zza;
                if (i5 < 0) {
                    ...
                    if (i5 == 0) {
                        ...
                        zzhy.zza(i, zzdu.zza(bArr, zza, i5));
                    }
                    return zza + i5;
                } else {
                    throw zzfo.zza();
                ...
                zzhy.zza(i, Integer.valueOf(zza(bArr, i2)));
                return i2 + 4;
            } else {
                throw zzfo.zzd();
            }
