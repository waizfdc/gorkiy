...
public final class zaaw extends GoogleApiClient implements zabs {
    ...
    public final void disconnect() {
        ...
        try {
            ...
            this.zahf.release();
            for (BaseImplementation.ApiMethodImpl next : this.zafd) {
                next.zaa((zacq) null);
                next.cancel();
            }
            this.zafd.clear();
    ...
    public final PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        StatusPendingResult statusPendingResult = new StatusPendingResult(super);
        if (this.zahd.containsKey(Common.CLIENT_KEY)) {
            zaa(super, statusPendingResult, false);
        } else {
    ...
    public final void zaa(GoogleApiClient googleApiClient, StatusPendingResult statusPendingResult, boolean z) {
        Common.zapw.zaa(super).setResultCallback(new zaba(this, statusPendingResult, z, super));
    }
