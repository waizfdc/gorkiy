...
public class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doRead(BaseImplementation.ApiMethodImpl apiMethodImpl) {
        return zaa(0, apiMethodImpl);
    }

    public <TResult, A extends Api.AnyClient> Task<TResult> doRead(TaskApiCall taskApiCall) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [android.content.Context, android.os.Looper, com.google.android.gms.common.internal.ClientSettings, O, com.google.android.gms.common.api.internal.GoogleApiManager$zaa<O>, com.google.android.gms.common.api.internal.GoogleApiManager$zaa<O>]
     candidates:
