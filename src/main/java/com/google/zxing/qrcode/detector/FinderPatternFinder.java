...
public class FinderPatternFinder {
    ...
    private boolean crossCheckDiagonal(int i, int i2, int i3, int i4) {
        ...
        int i13 = 0;
        while (i10 >= i13 && i11 >= i13 && this.image.get(i11 - i13, i10 - i13)) {
        ...
        while (i10 >= i13 && i11 >= i13 && !this.image.get(i11 - i13, i10 - i13) && crossCheckStateCount2[1] <= i12) {
            crossCheckStateCount2[1] = crossCheckStateCount2[1] + 1;
            i13++;
        }
        if (i10 < i13 || i11 < i13 || crossCheckStateCount2[1] > i12) {
            return false;
        }
        while (i10 >= i13 && i11 >= i13 && this.image.get(i11 - i13, i10 - i13) && crossCheckStateCount2[0] <= i12) {
        ...
        while (true) {
            i5 = i10 + i14;
            if (i5 < height && (i9 = i11 + i14) < width && this.image.get(i9, i5)) {
                crossCheckStateCount2[2] = crossCheckStateCount2[2] + 1;
                i14++;
            } else if (i5 >= height && i11 + i14 < width) {
                while (true) {
                    i6 = i10 + i14;
                    if (i6 < height && (i8 = i11 + i14) < width && !this.image.get(i8, i6) && crossCheckStateCount2[3] < i12) {
                        crossCheckStateCount2[3] = crossCheckStateCount2[3] + 1;
                        i14++;
                    } else if (i6 < height || i11 + i14 >= width || crossCheckStateCount2[3] >= i12) {
                        return false;
                    } else {
                        while (true) {
                            int i15 = i10 + i14;
                            if (i15 < height && (i7 = i11 + i14) < width && this.image.get(i7, i15) && crossCheckStateCount2[4] < i12) {
                                crossCheckStateCount2[4] = crossCheckStateCount2[4] + 1;
                                i14++;
                            }
                        }
                        if (crossCheckStateCount2[4] < i12 && Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) < i4 * 2 && foundPatternCross(crossCheckStateCount2)) {
                            return true;
                        }
                        return false;
                    }
