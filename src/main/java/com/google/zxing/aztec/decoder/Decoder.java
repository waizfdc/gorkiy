        ...
        while (i8 < nbLayers) {
            ...
            while (i14 < i11) {
                ...
                while (i16 < i2) {
                    ...
                    int i19 = iArr[i18];
                    int i20 = i13 - i16;
                    zArr[(i11 * 2) + i9 + i15 + i16] = bitMatrix2.get(i19, iArr[i20]);
                    int i21 = i13 - i14;
                    zArr[(i11 * 4) + i9 + i15 + i16] = bitMatrix2.get(iArr[i20], iArr[i21]);
                    zArr[(i11 * 6) + i9 + i15 + i16] = bitMatrix2.get(iArr[i21], iArr[i17]);
                    i16++;
                    i2 = 2;
                    nbLayers = nbLayers;
                    isCompact = isCompact;
