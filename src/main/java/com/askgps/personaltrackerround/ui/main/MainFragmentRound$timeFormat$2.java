...
final class MainFragmentRound$timeFormat$2 extends Lambda implements Function0<String> {
    final /* synthetic */ MainFragmentRound this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainFragmentRound$timeFormat$2(MainFragmentRound mainFragmentRound) {
        super(0);
