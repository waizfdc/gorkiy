...
final class MainFragmentRound$observeViewModel$2<T> implements Observer<Boolean> {
    final /* synthetic */ MainFragmentRound this$0;

    MainFragmentRound$observeViewModel$2(MainFragmentRound mainFragmentRound) {
