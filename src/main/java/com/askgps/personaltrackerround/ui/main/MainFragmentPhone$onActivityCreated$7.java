...
final class MainFragmentPhone$onActivityCreated$7 implements View.OnClickListener {
    final /* synthetic */ MainFragmentPhone this$0;

    MainFragmentPhone$onActivityCreated$7(MainFragmentPhone mainFragmentPhone) {
    ...
    public final void onClick(View view) {
        ...
        ContextExtensionKt.openUrl(context, MainFragmentPhone.NEWS_URL);
    }
}
