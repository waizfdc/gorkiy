...
final class MainFragmentRound$onActivityCreated$2 implements View.OnClickListener {
    final /* synthetic */ MainFragmentRound this$0;

    MainFragmentRound$onActivityCreated$2(MainFragmentRound mainFragmentRound) {
        this.this$0 = mainFragmentRound;
    }

    public final void onClick(View view) {
        MainFragmentRound.access$getViewModel$p(this.this$0).resetAttemptLeft();
        this.this$0.requestAddWhiteList();
