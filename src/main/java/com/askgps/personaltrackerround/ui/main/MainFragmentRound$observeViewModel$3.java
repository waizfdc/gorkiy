...
final class MainFragmentRound$observeViewModel$3<T> implements Observer<List<? extends PhoneNumber>> {
    public static final MainFragmentRound$observeViewModel$3 INSTANCE = new MainFragmentRound$observeViewModel$3();

    MainFragmentRound$observeViewModel$3() {
    }
