...
public final class PowerConnectionCompanion$$special$$inlined$inject$1 extends Lambda implements Function0<Repository> {
    final /* synthetic */ Function0 $parameters;
    final /* synthetic */ Qualifier $qualifier;
    final /* synthetic */ KoinComponent $this_inject;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PowerConnectionCompanion$$special$$inlined$inject$1(KoinComponent koinComponent, Qualifier qualifier, Function0 function0) {
        super(0);
    ...
    public final Repository invoke() {
        ...
        return koin.get_scopeRegistry().getRootScope().get(Reflection.getOrCreateKotlinClass(Repository.class), this.$qualifier, this.$parameters);
    }
}
