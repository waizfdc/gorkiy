...
final class PeriodicJobService$wifiUtils$2 extends Lambda implements Function0<WifiUtils> {
    final /* synthetic */ PeriodicJobService this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PeriodicJobService$wifiUtils$2(PeriodicJobService periodicJobService) {
        super(0);
        this.this$0 = periodicJobService;
    }

    public final WifiUtils invoke() {
        return new WifiUtils(this.this$0);
    }
}
