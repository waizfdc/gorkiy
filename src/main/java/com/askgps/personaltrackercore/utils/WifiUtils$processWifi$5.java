...
final class WifiUtils$processWifi$5 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Set $wifi;
    final /* synthetic */ WifiUtils this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WifiUtils$processWifi$5(WifiUtils wifiUtils, Set set) {
        super(0);
    ...
    public final void invoke() {
        ...
        LogKt.toFile$default(this.$wifi, "WIFI + updateLocation", null, WifiUtils.TAG, 2, null);
    }
}
