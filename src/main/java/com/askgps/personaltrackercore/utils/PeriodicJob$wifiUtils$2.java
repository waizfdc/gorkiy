...
final class PeriodicJob$wifiUtils$2 extends Lambda implements Function0<WifiUtils> {
    final /* synthetic */ PeriodicJob this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PeriodicJob$wifiUtils$2(PeriodicJob periodicJob) {
        super(0);
        this.this$0 = periodicJob;
    }

    public final WifiUtils invoke() {
        return new WifiUtils(this.this$0.context);
    }
}
