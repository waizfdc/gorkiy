...
public final class MainActivityViewModel$$special$$inlined$inject$1 extends Lambda implements Function0<Repository> {
    final /* synthetic */ Function0 $parameters;
    final /* synthetic */ Qualifier $qualifier;
    final /* synthetic */ KoinComponent $this_inject;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MainActivityViewModel$$special$$inlined$inject$1(KoinComponent koinComponent, Qualifier qualifier, Function0 function0) {
        super(0);
