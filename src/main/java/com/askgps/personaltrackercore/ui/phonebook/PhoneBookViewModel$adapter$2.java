...
final class PhoneBookViewModel$adapter$2 extends Lambda implements Function1<PhoneNumber, Unit> {
    final /* synthetic */ PhoneBookViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PhoneBookViewModel$adapter$2(PhoneBookViewModel phoneBookViewModel) {
        super(1);
    ...
    public final void invoke(PhoneNumber phoneNumber) {
        ...
        this.this$0.getActionPhoneNumber().onNext(TuplesKt.to(PhoneBookViewModel.Action.CALL, phoneNumber));
    }
}
