...
public final class CameraFragment extends DialogFragment {
    ...
    public static final /* synthetic */ AnimatedVectorDrawableCompat access$getAvd$p(CameraFragment cameraFragment) {
        AnimatedVectorDrawableCompat animatedVectorDrawableCompat = cameraFragment.avd;
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u000b\u001a\u00020\fR\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0019\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006¢\u0006\n\n\u0002\u0010\n\u001a\u0004\b\b\u0010\t¨\u0006\r"}, d2 = {"Lcom/askgps/personaltrackercore/ui/camera/CameraFragment$Companion;", "", "()V", "REQUEST_CAMERA_PERMISSION", "", "REQUIRED_PERMISSIONS", "", "", "getREQUIRED_PERMISSIONS", "()[Ljava/lang/String;", "[Ljava/lang/String;", "newInstance", "Lcom/askgps/personaltrackercore/ui/camera/CameraFragment;", "personaltrackercore_release"}, k = 1, mv = {1, 1, 16})
    /* compiled from: CameraFragment.kt */
    ...
    private final void initAvd() {
        ...
        animatedVectorDrawableCompat2.registerAnimationCallback(new CameraFragment$initAvd$1(this));
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if (BaseMainActivity.Companion.getCustomer() == CustomerCategory.BUILDER_WATCH) {
            ...
            idxId.observe(viewLifecycleOwner, new CameraFragment$onActivityCreated$1(this));
        }
        if (allPermissionsGranted()) {
            ((PreviewView) _$_findCachedViewById(R.id.camera_preview)).post(new CameraFragment$onActivityCreated$2(this));
        } else {
    ...
    public final void startCamera() {
        ...
        Runnable cameraFragment$startCamera$1 = new CameraFragment$startCamera$1(this, instance);
        Context context2 = getContext();
        if (context2 == null) {
            Intrinsics.throwNpe();
        }
        instance.addListener(cameraFragment$startCamera$1, ContextCompat.getMainExecutor(context2));
    }
    ...
    public final ImageAnalysis initImageAnalysis(ImageCapture imageCapture) {
        ...
        build.setAnalyzer(Executors.newSingleThreadExecutor(), new FaceDetector.FaceDetectorAnalyzer(new CameraFragment$initImageAnalysis$1(this, imageCapture)));
        return build;
    }
    ...
    public final void FaceDetectorAnalyzerCalbback(ImageCapture imageCapture, ImageProxy imageProxy) {
        ...
        imageCapture.lambda$takePicture$4$ImageCapture(new ImageCapture.OutputFileOptions.Builder(createImageFile).build(), Executors.newSingleThreadExecutor(), new CameraFragment$FaceDetectorAnalyzerCalbback$1(this, createImageFile, imageProxy));
    }
    ...
    public final ImageCapture initCapture() {
        ...
        ((AppCompatButton) _$_findCachedViewById(R.id.camera_btn_send)).setOnClickListener(new CameraFragment$initCapture$1(this, build));
        return build;
    }
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (allPermissionsGranted()) {
            ((PreviewView) _$_findCachedViewById(R.id.camera_preview)).post(new CameraFragment$onRequestPermissionsResult$1(this));
            return;
        }
