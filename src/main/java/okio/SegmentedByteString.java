...
public final class SegmentedByteString extends ByteString {
    ...
    public ByteString hmac$okio(String str, ByteString byteString) {
        ...
        try {
            ...
            instance.init(new SecretKeySpec(super.toByteArray(), str));
            int length = ((Object[]) getSegments$okio()).length;
            int i = 0;
            int i2 = 0;
            while (i < length) {
    ...
    public boolean rangeEquals(int i, ByteString byteString, int i2, int i3) {
        ...
        while (i < i5) {
            ...
            if (!super.rangeEquals(i2, getSegments$okio()[segment], i6 + (i - i4), min)) {
                return false;
            }
            i2 += min;
            i += min;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ByteString) {
            ...
            if (super.size() == size() && rangeEquals(0, super, 0, size())) {
                return true;
            }
        }
        return false;
