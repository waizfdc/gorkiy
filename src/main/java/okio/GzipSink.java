...
public final class GzipSink implements Sink {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: okio.DeflaterSink.<init>(okio.BufferedSink, java.util.zip.Deflater):void
     arg types: [okio.RealBufferedSink, java.util.zip.Deflater]
     candidates:
      okio.DeflaterSink.<init>(okio.Sink, java.util.zip.Deflater):void
      okio.DeflaterSink.<init>(okio.BufferedSink, java.util.zip.Deflater):void */
    ...
    public final Deflater m1186deprecated_deflater() {
        return this.deflater;
    }
}
