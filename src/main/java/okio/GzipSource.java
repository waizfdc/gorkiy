...
public final class GzipSource implements Source {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: okio.InflaterSource.<init>(okio.BufferedSource, java.util.zip.Inflater):void
     arg types: [okio.RealBufferedSource, java.util.zip.Inflater]
     candidates:
      okio.InflaterSource.<init>(okio.Source, java.util.zip.Inflater):void
      okio.InflaterSource.<init>(okio.BufferedSource, java.util.zip.Inflater):void */
