...
public class LockFreeLinkedListHead extends LockFreeLinkedListNode {
    ...
    public final /* synthetic */ <T extends LockFreeLinkedListNode> void forEach(Function1<? super T, Unit> function1) {
        ...
        Object next = getNext();
        if (next != null) {
            for (LockFreeLinkedListNode lockFreeLinkedListNode = (LockFreeLinkedListNode) next; !Intrinsics.areEqual(lockFreeLinkedListNode, this); lockFreeLinkedListNode = super.getNextNode()) {
    ...
    public final void validate$kotlinx_coroutines_core() {
        ...
        if (next != null) {
            ...
            while (!Intrinsics.areEqual(lockFreeLinkedListNode4, this)) {
                LockFreeLinkedListNode nextNode = super.getNextNode();
                super.validateNode$kotlinx_coroutines_core(super, super);
                lockFreeLinkedListNode3 = lockFreeLinkedListNode4;
                lockFreeLinkedListNode4 = nextNode;
            }
            Object next2 = getNext();
            if (next2 != null) {
                validateNode$kotlinx_coroutines_core(super, (LockFreeLinkedListNode) next2);
                return;
            }
            throw new TypeCastException("null cannot be cast to non-null type kotlinx.coroutines.internal.Node /* = kotlinx.coroutines.internal.LockFreeLinkedListNode */");
        }
