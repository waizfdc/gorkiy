...
final class AwaitAll<T> {
    ...
    private final class AwaitAllNode extends JobNode<Job> {
        ...
        public AwaitAllNode(kotlinx.coroutines.AwaitAll r2, kotlinx.coroutines.CancellableContinuation<? super java.util.List<? extends T>> r3, kotlinx.coroutines.Job r4) {
            /*
                r1 = this;
