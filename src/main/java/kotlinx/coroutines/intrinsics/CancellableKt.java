...
public final class CancellableKt {
    public static final <T> void startCoroutineCancellable(Function1 function1, Continuation continuation) {
        ...
        try {
            ...
            DispatchedContinuationKt.resumeCancellableWith(intercepted, Result.m3constructorimpl(Unit.INSTANCE));
        } catch (Throwable th) {
    ...
    public static final void startCoroutineCancellable(Continuation<? super Unit> continuation, Continuation<?> continuation2) {
        Intrinsics.checkParameterIsNotNull(continuation, "$this$startCoroutineCancellable");
        Intrinsics.checkParameterIsNotNull(continuation2, "fatalCompletion");
        try {
