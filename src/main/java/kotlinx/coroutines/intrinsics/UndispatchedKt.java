...
public final class UndispatchedKt {
    public static final <T, R> Object startUndispatchedOrReturn(ScopeCoroutine<? super T> scopeCoroutine, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        Object obj;
        Intrinsics.checkParameterIsNotNull(scopeCoroutine, "$this$startUndispatchedOrReturn");
        ...
        throw StackTraceRecoveryKt.recoverStackTrace(completedExceptionally.cause, scopeCoroutine.uCont);
    }
    ...
    public static final <T, R> Object startUndispatchedOrReturnIgnoreTimeout(ScopeCoroutine<? super T> scopeCoroutine, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        Object obj;
        Intrinsics.checkParameterIsNotNull(scopeCoroutine, "$this$startUndispatchedOrReturnIgnoreTimeout");
        Intrinsics.checkParameterIsNotNull(function2, "block");
        scopeCoroutine.initParentJob$kotlinx_coroutines_core();
        boolean z = false;
        try {
        ...
        if (z) {
            ...
            throw StackTraceRecoveryKt.recoverStackTrace(((CompletedExceptionally) obj).cause, scopeCoroutine.uCont);
        }
    }
