...
final /* synthetic */ class FlowKt__BuildersKt {
    ...
    public static final <T> Flow<T> asFlow(Function0 function0) {
    ...
    public static final <T> Flow<T> asFlow(Iterable iterable) {
        Intrinsics.checkParameterIsNotNull(iterable, "$this$asFlow");
        return new FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3(iterable);
    }

    public static final <T> Flow<T> asFlow(Iterator it) {
        Intrinsics.checkParameterIsNotNull(it, "$this$asFlow");
        return new FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4(it);
    }

    public static final <T> Flow<T> asFlow(Sequence sequence) {
    ...
    public static final <T> Flow<T> flowOf(Object... objArr) {
        Intrinsics.checkParameterIsNotNull(objArr, "elements");
        return new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1(objArr);
    }

    public static final <T> Flow<T> flowOf(Object obj) {
        return new FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$2(obj);
    }

    public static final <T> Flow<T> asFlow(Object[] objArr) {
        Intrinsics.checkParameterIsNotNull(objArr, "$this$asFlow");
