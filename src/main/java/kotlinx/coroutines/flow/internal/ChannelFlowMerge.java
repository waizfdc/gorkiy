...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [kotlinx.coroutines.flow.Flow<? extends kotlinx.coroutines.flow.Flow<? extends T>>, java.lang.Object, kotlinx.coroutines.flow.Flow<kotlinx.coroutines.flow.Flow<T>>] */
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public ChannelFlowMerge(kotlinx.coroutines.flow.Flow<? extends kotlinx.coroutines.flow.Flow<? extends T>> r2, int r3, kotlin.coroutines.CoroutineContext r4, int r5) {
        /*
            r1 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.internal.ChannelFlowMerge.<init>(kotlinx.coroutines.flow.Flow, int, kotlin.coroutines.CoroutineContext, int):void");
    }
