...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> onErrorCollect(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        ...
        return FlowKt.m1024catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, null));
    }
    ...
    public static final <T> Flow<T> retry(Flow flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
    ...
    public static final /* synthetic */ <T> Flow<T> retry(Flow flow, int i, Function1<? super Throwable, Boolean> function1) {
        Intrinsics.checkParameterIsNotNull(flow, "$this$retry");
        Intrinsics.checkParameterIsNotNull(function1, "predicate");
        if (i > 0) {
    ...
    public static final <T> Flow<T> m1025catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
