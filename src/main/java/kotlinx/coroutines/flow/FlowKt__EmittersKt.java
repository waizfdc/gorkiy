...
final /* synthetic */ class FlowKt__EmittersKt {
    ...
    public static final /* synthetic */ <T> Flow<T> onCompletion(Flow flow, Function2<? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function2) {
    ...
    public static final <T> Flow<T> onCompletion(Flow flow, Function3 function3) {
        Intrinsics.checkParameterIsNotNull(flow, "$this$onCompletion");
