...
public final class DispatchedTaskKt {
    ...
    public static final <T> void resume(DispatchedTask<? super T> dispatchedTask, Continuation<? super T> continuation, int i) {
        ...
        if (recoverStackTrace != null) {
            ...
            obj = Result.m3constructorimpl(ResultKt.createFailure(recoverStackTrace));
        } else {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m3constructorimpl(takeState$kotlinx_coroutines_core);
        }
        if (i == 0) {
    ...
    public static final void runUnconfinedEventLoop(DispatchedTask<?> dispatchedTask, EventLoop eventLoop, Function0<Unit> function0) {
        Intrinsics.checkParameterIsNotNull(dispatchedTask, "$this$runUnconfinedEventLoop");
