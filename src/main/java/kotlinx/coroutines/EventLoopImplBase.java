...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(long, long):long
     arg types: [long, int]
     candidates:
      kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(byte, byte):byte
      kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(double, double):double
      kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(float, float):float
      kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(int, int):int
      kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(java.lang.Comparable, java.lang.Comparable):T
      kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(short, short):short
      kotlin.ranges.RangesKt___RangesKt.coerceAtLeast(long, long):long */
    /* access modifiers changed from: protected */
    ...
    public static abstract class DelayedTask implements Runnable, Comparable<DelayedTask>, DisposableHandle, ThreadSafeHeapNode {
        ...
        public int compareTo(DelayedTask delayedTask) {
            Intrinsics.checkParameterIsNotNull(delayedTask, FitnessActivities.OTHER);
    ...
    private final class DelayedResumeTask extends DelayedTask {
        ...
        /* JADX WARN: Type inference failed for: r5v0, types: [java.lang.Object, kotlinx.coroutines.CancellableContinuation<kotlin.Unit>, kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit>] */
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        /* JADX WARNING: Unknown variable types count: 1 */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public DelayedResumeTask(kotlinx.coroutines.EventLoopImplBase r2, long r3, kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit> r5) {
            /*
                r1 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.EventLoopImplBase.DelayedResumeTask.<init>(kotlinx.coroutines.EventLoopImplBase, long, kotlinx.coroutines.CancellableContinuation):void");
        }
