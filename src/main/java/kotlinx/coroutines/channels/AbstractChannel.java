...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final Object receiveOrClosed(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        ...
        if (pollInternal instanceof Closed) {
            ...
            obj = ValueOrClosed.m1014constructorimpl(new ValueOrClosed.Closed(((Closed) pollInternal).closeCause));
        } else {
            ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
            obj = ValueOrClosed.m1014constructorimpl(pollInternal);
        }
        return ValueOrClosed.m1013boximpl(obj);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r1 = InlineList.m1028constructorimpl$default(null, 1, null);
            while (true) {
                ...
                if (prevNode instanceof LockFreeLinkedListHead) {
                    ...
                    r1 = InlineList.m1033plusimpl(r1, (Send) prevNode);
                } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1013boximpl(ValueOrClosed.m1014constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause))), selectInstance.getCompletion());
            }
        } else if (i == 2) {
            ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
            if (z) {
                obj2 = ValueOrClosed.m1014constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause));
            } else {
                obj2 = ValueOrClosed.m1014constructorimpl(obj);
            }
            UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1013boximpl(obj2), selectInstance.getCompletion());
        } else {
    ...
    private static final class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.Companion;
            return ValueOrClosed.m1013boximpl(ValueOrClosed.m1014constructorimpl(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            if (this.receiveMode == 1 && closed.closeCause == null) {
                ...
                ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                ValueOrClosed r3 = ValueOrClosed.m1013boximpl(ValueOrClosed.m1014constructorimpl(new ValueOrClosed.Closed(closed.closeCause)));
                Result.Companion companion3 = Result.Companion;
                this.cont.resumeWith(Result.m3constructorimpl(r3));
            } else {
                Throwable receiveException = closed.getReceiveException();
    ...
    private static final class ReceiveHasNext<E> extends Receive<E> {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public ReceiveHasNext(kotlinx.coroutines.channels.AbstractChannel.Itr<E> r2, kotlinx.coroutines.CancellableContinuation<? super java.lang.Boolean> r3) {
            /*
                r1 = this;
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        /* JADX WARN: Type inference failed for: r4v0, types: [java.lang.Object, kotlin.jvm.functions.Function2<java.lang.Object, kotlin.coroutines.Continuation<? super R>, java.lang.Object>, kotlin.jvm.functions.Function2<java.lang.Object, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object>] */
        /* JADX WARNING: Unknown variable types count: 1 */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public ReceiveSelect(kotlinx.coroutines.channels.AbstractChannel<E> r2, kotlinx.coroutines.selects.SelectInstance<? super R> r3, kotlin.jvm.functions.Function2<java.lang.Object, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r4, int r5) {
            /*
                r1 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.ReceiveSelect.<init>(kotlinx.coroutines.channels.AbstractChannel, kotlinx.coroutines.selects.SelectInstance, kotlin.jvm.functions.Function2, int):void");
        }
        ...
        public void completeResumeReceive(E e) {
            ...
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                e = ValueOrClosed.m1013boximpl(ValueOrClosed.m1014constructorimpl(e));
            }
            ...
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    if (i == 2) {
                        Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                        ContinuationKt.startCoroutine(function2, ValueOrClosed.m1013boximpl(ValueOrClosed.m1014constructorimpl(new ValueOrClosed.Closed(closed.closeCause))), this.select.getCompletion());
                    }
                ...
                if (!enqueueReceive(receive)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            Result.Companion companion = Result.Companion;
                            cancellableContinuation.resumeWith(Result.m3constructorimpl(resumeValue));
                            break;
                        }
                    } else {
