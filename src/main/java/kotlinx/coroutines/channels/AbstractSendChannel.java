...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m1028constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m1033plusimpl(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    private static final class SendSelect<E, R> extends Send implements DisposableHandle {
        ...
        /* JADX WARN: Type inference failed for: r5v0, types: [java.lang.Object, kotlin.jvm.functions.Function2<kotlinx.coroutines.channels.SendChannel<? super E>, kotlin.coroutines.Continuation<? super R>, java.lang.Object>, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.channels.SendChannel<? super E>, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object>] */
        /* JADX WARNING: Unknown variable types count: 1 */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public SendSelect(java.lang.Object r2, kotlinx.coroutines.channels.AbstractSendChannel<E> r3, kotlinx.coroutines.selects.SelectInstance<? super R> r4, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.channels.SendChannel<? super E>, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r5) {
            /*
                r1 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractSendChannel.SendSelect.<init>(java.lang.Object, kotlinx.coroutines.channels.AbstractSendChannel, kotlinx.coroutines.selects.SelectInstance, kotlin.jvm.functions.Function2):void");
        }
        ...
        while (true) {
            if (getFull()) {
                ...
                if (access$enqueueSend == null) {
                    ...
                    helpCloseAndResumeWithSendException(cancellableContinuation, (Closed) access$enqueueSend);
                    break;
