...
public class JobImpl extends JobSupport implements CompletableJob {
    ...
    private final boolean handlesException() {
        ...
        if (!(childHandleNode == null || (jobSupport = (JobSupport) childHandleNode.job) == null)) {
            while (!super.getHandlesException$kotlinx_coroutines_core()) {
                ChildHandle parentHandle$kotlinx_coroutines_core2 = super.getParentHandle$kotlinx_coroutines_core();
