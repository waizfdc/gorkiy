...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        private final class PrepareOp extends OpDescriptor {
            ...
            public PrepareOp(TryLockDesc tryLockDesc, AtomicOp<?> atomicOp2) {
                Intrinsics.checkParameterIsNotNull(atomicOp2, "atomicOp");
    ...
    private static final class LockCont extends LockWaiter {
        ...
        public LockCont(java.lang.Object r2, kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit> r3) {
            /*
                r1 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.sync.MutexImpl.LockCont.<init>(java.lang.Object, kotlinx.coroutines.CancellableContinuation):void");
        }
    ...
    private static final class LockSelect<R> extends LockWaiter {
        ...
        /* JADX WARN: Type inference failed for: r5v0, types: [kotlin.jvm.functions.Function2<kotlinx.coroutines.sync.Mutex, kotlin.coroutines.Continuation<? super R>, java.lang.Object>, java.lang.Object, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.sync.Mutex, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object>] */
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        /* JADX WARNING: Unknown variable types count: 1 */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public LockSelect(java.lang.Object r2, kotlinx.coroutines.sync.Mutex r3, kotlinx.coroutines.selects.SelectInstance<? super R> r4, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.sync.Mutex, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r5) {
            /*
                r1 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.sync.MutexImpl.LockSelect.<init>(java.lang.Object, kotlinx.coroutines.sync.Mutex, kotlinx.coroutines.selects.SelectInstance, kotlin.jvm.functions.Function2):void");
        }
        ...
        while (true) {
            ...
            if (obj3 instanceof Empty) {
                ...
                if (lockedQueue.owner != obj2) {
                    ...
                    LockFreeLinkedListNode.CondAddOp mutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutineReusable$lambda$1 = new MutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutineReusable$lambda$1(lockFreeLinkedListNode, lockFreeLinkedListNode, obj3, cancellableContinuation, lockCont, this, obj);
                    while (true) {
                        Object prev = lockedQueue.getPrev();
                        if (prev != null) {
                            int tryCondAddNext = ((LockFreeLinkedListNode) prev).tryCondAddNext(lockFreeLinkedListNode2, lockedQueue, mutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutineReusable$lambda$1);
                            if (tryCondAddNext != 1) {
                                if (tryCondAddNext == 2) {
                                    z = false;
                                    break;
