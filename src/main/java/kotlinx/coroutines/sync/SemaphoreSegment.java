...
final class SemaphoreSegment extends Segment<SemaphoreSegment> {
    ...
    public SemaphoreSegment(long j, SemaphoreSegment superR) {
        super(j, superR);
    }
