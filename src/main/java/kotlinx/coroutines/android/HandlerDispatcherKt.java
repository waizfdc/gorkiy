...
public final class HandlerDispatcherKt {
    ...
    public static final Handler asHandler(Looper looper, boolean z) {
        ...
        try {
            Constructor<Handler> declaredConstructor = cls.getDeclaredConstructor(Looper.class, Handler.Callback.class, Boolean.TYPE);
            Intrinsics.checkExpressionValueIsNotNull(declaredConstructor, "Handler::class.java.getD…:class.javaPrimitiveType)");
            Handler newInstance = declaredConstructor.newInstance(looper, null, true);
