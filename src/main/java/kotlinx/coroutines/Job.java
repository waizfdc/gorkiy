...
public interface Job extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        ...
        public static Job plus(Job job, Job job2) {
            Intrinsics.checkParameterIsNotNull(job2, FitnessActivities.OTHER);
            return job2;
        }
