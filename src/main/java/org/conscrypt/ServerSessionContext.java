...
public final class ServerSessionContext extends AbstractSessionContext {
    ...
    ServerSessionContext() {
        super(100);
        NativeCrypto.SSL_CTX_set_session_id_context(this.sslCtxNativePointer, super, new byte[]{32});
    }
    ...
    public NativeSslSession getSessionFromPersistentCache(byte[] bArr) {
        ...
        if (sSLServerSessionCache == null || (sessionData = sSLServerSessionCache.getSessionData(bArr)) == null || (newInstance = NativeSslSession.newInstance(super, sessionData, null, -1)) == null || !newInstance.isValid()) {
            return null;
        }
