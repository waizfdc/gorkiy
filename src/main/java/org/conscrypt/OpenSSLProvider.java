...
public final class OpenSSLProvider extends Provider {
    ...
    OpenSSLProvider(String str, boolean z) {
        ...
        put("Alg.Alias.MessageDigest.SHA", CommonUtils.SHA1_INSTANCE);
        put("Alg.Alias.MessageDigest.1.3.14.3.2.26", CommonUtils.SHA1_INSTANCE);
        ...
        put("Alg.Alias.MessageDigest.SHA256", CommonUtils.SHA256_INSTANCE);
        put("Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.1", CommonUtils.SHA256_INSTANCE);
