...
class CollectionsKt__MutableCollectionsKt extends CollectionsKt__MutableCollectionsJVMKt {
    ...
    private static final <T> boolean removeAll(Collection collection, Collection collection2) {
        if (collection != null) {
    ...
    private static final <T> boolean retainAll(Collection collection, Collection collection2) {
        if (collection != null) {
    ...
    public static final <T> boolean addAll(Collection collection, Iterable iterable) {
    ...
    public static final <T> boolean addAll(Collection collection, Sequence sequence) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$addAll");
    ...
    public static final <T> boolean addAll(Collection collection, Object[] objArr) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$addAll");
        Intrinsics.checkParameterIsNotNull(objArr, "elements");
        return collection.addAll(ArraysKt.asList(objArr));
    }

    public static final <T> boolean removeAll(Collection collection, Iterable iterable) {
    ...
    public static final <T> boolean removeAll(Collection collection, Sequence sequence) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$removeAll");
        Intrinsics.checkParameterIsNotNull(sequence, "elements");
    ...
    public static final <T> boolean removeAll(Collection collection, Object[] objArr) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$removeAll");
        Intrinsics.checkParameterIsNotNull(objArr, "elements");
        return ((objArr.length == 0) ^ true) && collection.removeAll(ArraysKt.toHashSet(objArr));
    }

    public static final <T> boolean retainAll(Collection collection, Iterable iterable) {
    ...
    public static final <T> boolean retainAll(Collection collection, Object[] objArr) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$retainAll");
        Intrinsics.checkParameterIsNotNull(objArr, "elements");
        if (!(objArr.length == 0)) {
            return collection.retainAll(ArraysKt.toHashSet(objArr));
        }
        return retainNothing$CollectionsKt__MutableCollectionsKt(collection);
    }

    public static final <T> boolean retainAll(Collection collection, Sequence sequence) {
        Intrinsics.checkParameterIsNotNull(collection, "$this$retainAll");
        Intrinsics.checkParameterIsNotNull(sequence, "elements");
        Collection hashSet = SequencesKt.toHashSet(sequence);
        if (!hashSet.isEmpty()) {
    ...
    public static final <T> boolean removeAll(Iterable iterable, Function1 function1) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      kotlin.collections.CollectionsKt__MutableCollectionsKt.filterInPlace$CollectionsKt__MutableCollectionsKt(java.util.List, kotlin.jvm.functions.Function1, boolean):boolean
      kotlin.collections.CollectionsKt__MutableCollectionsKt.filterInPlace$CollectionsKt__MutableCollectionsKt(java.lang.Iterable, kotlin.jvm.functions.Function1, boolean):boolean */
    public static final <T> boolean retainAll(Iterable iterable, Function1 function1) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      kotlin.collections.CollectionsKt__MutableCollectionsKt.filterInPlace$CollectionsKt__MutableCollectionsKt(java.lang.Iterable, kotlin.jvm.functions.Function1, boolean):boolean
      kotlin.collections.CollectionsKt__MutableCollectionsKt.filterInPlace$CollectionsKt__MutableCollectionsKt(java.util.List, kotlin.jvm.functions.Function1, boolean):boolean */
    public static final <T> boolean removeAll(List list, Function1 function1) {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      kotlin.collections.CollectionsKt__MutableCollectionsKt.filterInPlace$CollectionsKt__MutableCollectionsKt(java.lang.Iterable, kotlin.jvm.functions.Function1, boolean):boolean
      kotlin.collections.CollectionsKt__MutableCollectionsKt.filterInPlace$CollectionsKt__MutableCollectionsKt(java.util.List, kotlin.jvm.functions.Function1, boolean):boolean */
    public static final <T> boolean retainAll(List list, Function1 function1) {
