...
class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    /* JADX WARN: Type inference failed for: r1v0, types: [R, java.util.Map, M] */
    ...
    public static final <K, V> void putAll(Map map, Pair[] pairArr) {
    ...
    public static final <K, V> void putAll(Map map, Iterable iterable) {
        Intrinsics.checkParameterIsNotNull(map, "$this$putAll");
    ...
    public static final <K, V> void putAll(Map map, Sequence sequence) {
        Intrinsics.checkParameterIsNotNull(map, "$this$putAll");
