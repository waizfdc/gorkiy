...
class ArraysKt___ArraysJvmKt extends ArraysKt__ArraysKt {
    ...
    public static final <T> List<T> asList(Object[] objArr) {
        Intrinsics.checkParameterIsNotNull(objArr, "$this$asList");
        List<T> asList = ArraysUtilJVM.asList(objArr);
    ...
    public static final <T> T[] copyInto(Object[] objArr, Object[] objArr2, int i, int i2, int i3) {
        Intrinsics.checkParameterIsNotNull(objArr, "$this$copyInto");
        Intrinsics.checkParameterIsNotNull(objArr2, FirebaseAnalytics.Param.DESTINATION);
    ...
    public static final <T> T[] copyOfRange(Object[] objArr, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(objArr, "$this$copyOfRangeImpl");
        ArraysKt.copyOfRangeToIndexCheck(i2, objArr.length);
        T[] copyOfRange = Arrays.copyOfRange(objArr, i, i2);
        Intrinsics.checkExpressionValueIsNotNull(copyOfRange, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
        return copyOfRange;
    }
    ...
    public static final <T> void fill(Object[] objArr, Object obj, int i, int i2) {
        Intrinsics.checkParameterIsNotNull(objArr, "$this$fill");
    ...
    private static final <T extends Comparable<? super T>> void sort(Comparable[] comparableArr) {
    ...
    public static final <T> void sort(Object[] objArr) {
        Intrinsics.checkParameterIsNotNull(objArr, "$this$sort");
        if (objArr.length > 1) {
            Arrays.sort(objArr);
        }
    }
    ...
    public static final SortedSet<Boolean> toSortedSet(boolean[] zArr) {
        ...
        return (SortedSet) ArraysKt.toCollection(zArr, (Collection) new TreeSet());
    }
