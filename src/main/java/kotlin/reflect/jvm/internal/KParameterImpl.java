...
public final class KParameterImpl implements KParameter {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof KParameterImpl) {
            ...
            return Intrinsics.areEqual(this.callable, kParameterImpl.callable) && Intrinsics.areEqual(getDescriptor(), kParameterImpl.getDescriptor());
        }
    }
