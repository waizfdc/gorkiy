...
final class KParameterImpl$type$1 extends Lambda implements Function0<Type> {
    ...
    public final Type invoke() {
        ...
        if (!(access$getDescriptor$p instanceof ReceiverParameterDescriptor) || !Intrinsics.areEqual(UtilKt.getInstanceReceiverParameter(this.this$0.getCallable().getDescriptor()), access$getDescriptor$p) || this.this$0.getCallable().getDescriptor().getKind() != CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
