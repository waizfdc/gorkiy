...
public final class NewCapturedType extends SimpleType implements CapturedTypeMarker {
    ...
    public NewCapturedType(CaptureStatus captureStatus2, UnwrappedType unwrappedType, TypeProjection typeProjection) {
        this(captureStatus2, new NewCapturedTypeConstructor(typeProjection, (Function0) null, (NewCapturedTypeConstructor) null, 6, (DefaultConstructorMarker) null), unwrappedType, null, false, 24, null);
        Intrinsics.checkParameterIsNotNull(captureStatus2, "captureStatus");
