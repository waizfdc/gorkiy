...
public final class IncompatibleVersionErrorData<T extends BinaryVersion> {
    ...
    public String toString() {
        return "IncompatibleVersionErrorData(actualVersion=" + ((Object) this.actualVersion) + ", expectedVersion=" + ((Object) this.expectedVersion) + ", filePath=" + this.filePath + ", classId=" + this.classId + ")";
    }
