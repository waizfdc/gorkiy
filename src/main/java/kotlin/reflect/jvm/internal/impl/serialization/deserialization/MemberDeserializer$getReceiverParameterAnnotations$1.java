...
final class MemberDeserializer$getReceiverParameterAnnotations$1 extends Lambda implements Function0<List<? extends AnnotationDescriptor>> {
    ...
    public final List<AnnotationDescriptor> invoke() {
        ...
        List<AnnotationDescriptor> loadExtensionReceiverParameterAnnotations = access$asProtoContainer != null ? this.this$0.c.getComponents().getAnnotationAndConstantLoader().loadExtensionReceiverParameterAnnotations(access$asProtoContainer, this.$proto, this.$kind) : null;
