...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    public ClassDescriptor substitute(TypeSubstitutor typeSubstitutor) {
        ...
        return new LazySubstitutingClassDescriptor(super, TypeSubstitutor.createChainedSubstitutor(typeSubstitutor.getSubstitution(), getSubstitutor().getSubstitution()));
    }
