...
class StringsKt__AppendableKt {
    ...
    public static final <T extends Appendable> T append(Appendable appendable, CharSequence... charSequenceArr) {
        Intrinsics.checkParameterIsNotNull(appendable, "$this$append");
