...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final File normalize(File file) {
        ...
        String str = File.separator;
        Intrinsics.checkExpressionValueIsNotNull(str, "File.separator");
        return FilesKt.resolve(root, CollectionsKt.joinToString$default(normalize$FilesKt__UtilsKt(components.getSegments()), str, null, null, 0, null, null, 62, null));
    }
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [java.lang.CharSequence, char, int, int, ?[OBJECT, ARRAY]]
     candidates:
