...
public final class FilePathComponents {
    ...
    /* JADX WARN: Type inference failed for: r3v0, types: [java.util.List<java.io.File>, java.lang.Object, java.util.List<? extends java.io.File>] */
    ...
    public final File subPath(int i, int i2) {
        ...
        return new File(CollectionsKt.joinToString$default(this.segments.subList(i, i2), str, null, null, 0, null, null, 62, null));
    }
}
