...
public final class JvmClassMappingKt {
    ...
    public static final <T> Class<T> getJavaClass(KClass kClass) {
    ...
    public static final <T> Class<T> getJavaClass(Object obj) {
        Intrinsics.checkParameterIsNotNull(obj, "$this$javaClass");
