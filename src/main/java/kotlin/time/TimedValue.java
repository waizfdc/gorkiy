...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1009copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1010copyRFiDyg4(obj, d);
    }
    ...
    public String toString() {
        return "TimedValue(value=" + ((Object) this.value) + ", duration=" + Duration.m997toStringimpl(this.duration) + ")";
    }
