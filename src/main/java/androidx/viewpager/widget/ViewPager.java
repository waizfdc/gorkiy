...
public class ViewPager extends ViewGroup {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: androidx.viewpager.widget.PagerAdapter.destroyItem(android.view.ViewGroup, int, java.lang.Object):void
     arg types: [androidx.viewpager.widget.ViewPager, int, java.lang.Object]
     candidates:
      androidx.viewpager.widget.PagerAdapter.destroyItem(android.view.View, int, java.lang.Object):void
      androidx.viewpager.widget.PagerAdapter.destroyItem(android.view.ViewGroup, int, java.lang.Object):void */
    public void setAdapter(PagerAdapter pagerAdapter) {
        PagerAdapter pagerAdapter2 = this.mAdapter;
        if (pagerAdapter2 != null) {
            pagerAdapter2.setViewPagerObserver(null);
            this.mAdapter.startUpdate((ViewGroup) super);
            for (int i = 0; i < this.mItems.size(); i++) {
                ItemInfo itemInfo = this.mItems.get(i);
                this.mAdapter.destroyItem((ViewGroup) super, itemInfo.position, itemInfo.object);
            }
            this.mAdapter.finishUpdate((ViewGroup) super);
            this.mItems.clear();
            removeNonDecorViews();
            this.mCurItem = 0;
            scrollTo(0, 0);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: androidx.viewpager.widget.PagerAdapter.instantiateItem(android.view.ViewGroup, int):java.lang.Object
     ...
     candidates:
      ...
      androidx.viewpager.widget.PagerAdapter.instantiateItem(android.view.ViewGroup, int):java.lang.Object */
    /* access modifiers changed from: package-private */
    public ItemInfo addNewItem(int i, int i2) {
        ItemInfo itemInfo = new ItemInfo();
        itemInfo.position = i;
        itemInfo.object = this.mAdapter.instantiateItem((ViewGroup) super, i);
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     candidates:
      ...
      androidx.viewpager.widget.PagerAdapter.destroyItem(android.view.ViewGroup, int, java.lang.Object):void */
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: androidx.viewpager.widget.PagerAdapter.setPrimaryItem(android.view.ViewGroup, int, java.lang.Object):void
     arg types: [androidx.viewpager.widget.ViewPager, int, java.lang.Object]
     candidates:
      androidx.viewpager.widget.PagerAdapter.setPrimaryItem(android.view.View, int, java.lang.Object):void
      androidx.viewpager.widget.PagerAdapter.setPrimaryItem(android.view.ViewGroup, int, java.lang.Object):void */
    /* access modifiers changed from: package-private */
    ...
    private Rect getChildRectInPagerCoordinates(Rect rect, View view) {
        ...
        while ((parent instanceof ViewGroup) && parent != this) {
            ...
            rect.left += super.getLeft();
            rect.right += super.getRight();
            rect.top += super.getTop();
            rect.bottom += super.getBottom();
