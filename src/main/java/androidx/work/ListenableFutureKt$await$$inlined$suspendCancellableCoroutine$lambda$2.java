...
public final class ListenableFutureKt$await$$inlined$suspendCancellableCoroutine$lambda$2 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            this.$cancellableContinuation.resumeWith(Result.m3constructorimpl(obj));
        } catch (Throwable th) {
            ...
            this.$cancellableContinuation.resumeWith(Result.m3constructorimpl(ResultKt.createFailure(cause)));
        }
    }
}
