...
public class MotionController {
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            this.mAttributeInterpCount[i6] = 1;
            int i7 = 0;
            while (true) {
                if (i7 >= size) {
                    break;
                } else if (motionPathsArr[i6].attributes.containsKey(str5)) {
                    this.mAttributeInterpCount[i6] = motionPathsArr[i6].attributes.get(str5).noOfInterpValues();
                    break;
                } else {
                    i7++;
                }
            ...
            while (i17 < size) {
                if (motionPathsArr[i17].hasCustomData(str7)) {
                    if (dArr3 == null) {
                        ...
                        iArr4[1] = motionPathsArr[i17].getCustomDataCount(str7);
                        iArr4[i3] = size;
                        dArr3 = (double[][]) Array.newInstance((Class<?>) cls, iArr4);
