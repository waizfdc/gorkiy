...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    static class OverlayViewGroup extends ViewGroup {
        ...
        OverlayViewGroup(Context context, ViewGroup viewGroup, View view, ViewOverlayApi14 viewOverlayApi14) {
            super(context);
            this.mHostView = super;
            this.mRequestingView = view;
            setRight(super.getWidth());
            setBottom(super.getHeight());
            super.addView(this);
        ...
        public void add(View view) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                if (!(viewGroup == this.mHostView || super.getParent() == null || !ViewCompat.isAttachedToWindow(viewGroup))) {
                    int[] iArr = new int[2];
                    int[] iArr2 = new int[2];
