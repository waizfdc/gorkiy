...
class GhostViewPort extends ViewGroup implements GhostView {
    ...
    static void calculateMatrix(View view, ViewGroup viewGroup, Matrix matrix) {
        ...
        matrix.preTranslate((float) (-super.getScrollX()), (float) (-super.getScrollY()));
    ...
    static GhostViewPort addGhost(View view, ViewGroup viewGroup, Matrix matrix) {
        ...
        if (view.getParent() instanceof ViewGroup) {
            GhostViewHolder holder = GhostViewHolder.getHolder(super);
            ...
            if (ghostView == null) {
                if (matrix == null) {
                    matrix = new Matrix();
                    calculateMatrix(view, super, matrix);
                }
                ghostView = new GhostViewPort(view);
                ghostView.setMatrix(matrix);
                if (holder == null) {
                    holder = new GhostViewHolder(super);
                } else {
