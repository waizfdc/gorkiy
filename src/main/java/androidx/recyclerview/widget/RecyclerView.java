...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public View focusSearch(View view, int i) {
        ...
        if (!z3 || !(i == 2 || i == 1)) {
            View findNextFocus = instance.findNextFocus(super, view, i);
            ...
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? 130 : 33;
                z = instance.findNextFocus(super, view, i2) == null;
            ...
            if (!z && this.mLayout.canScrollHorizontally()) {
                ...
                if (instance.findNextFocus(super, view, i3) != null) {
                    z2 = false;
                }
                if (FORCE_ABS_FOCUS_SEARCH_DIRECTION) {
                    i = i3;
            ...
            view2 = instance.findNextFocus(super, view, i);
        }
    ...
    static RecyclerView findNestedRecyclerView(View view) {
        ...
        for (int i = 0; i < childCount; i++) {
            RecyclerView findNestedRecyclerView = findNestedRecyclerView(super.getChildAt(i));
