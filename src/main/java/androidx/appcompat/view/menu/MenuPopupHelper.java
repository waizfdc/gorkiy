...
public class MenuPopupHelper implements MenuHelper {
    ...
    /* JADX WARN: Type inference failed for: r0v7, types: [androidx.appcompat.view.menu.MenuPopup] */
    /* JADX WARN: Type inference failed for: r7v1, types: [androidx.appcompat.view.menu.StandardMenuPopup] */
    /* JADX WARN: Type inference failed for: r1v13, types: [androidx.appcompat.view.menu.CascadingMenuPopup] */
