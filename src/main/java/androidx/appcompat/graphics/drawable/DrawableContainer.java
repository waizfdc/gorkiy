...
class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    private boolean needsMirroring() {
        if (!isAutoMirrored() || DrawableCompat.getLayoutDirection(super) != 1) {
            return false;
        }
        return true;
    }
    ...
    public void setDither(boolean z) {
        if (this.mDrawableContainerState.mDither != z) {
            ...
            Drawable drawable = this.mCurrDrawable;
            if (drawable != null) {
                super.setDither(this.mDrawableContainerState.mDither);
            }
        }
    }
    ...
    public void setAutoMirrored(boolean z) {
        if (this.mDrawableContainerState.mAutoMirrored != z) {
            ...
            Drawable drawable = this.mCurrDrawable;
            if (drawable != null) {
                DrawableCompat.setAutoMirrored(super, this.mDrawableContainerState.mAutoMirrored);
            }
        }
    }
    ...
    public void scheduleDrawable(Drawable drawable, Runnable runnable, long j) {
        if (drawable == this.mCurrDrawable && getCallback() != null) {
            getCallback().scheduleDrawable(super, runnable, j);
        }
    }
    ...
    private void initializeDrawableForDisplay(Drawable drawable) {
        ...
        super.setCallback(this.mBlockInvalidateCallback.wrap(super.getCallback()));
        try {
            if (this.mDrawableContainerState.mEnterFadeDuration <= 0 && this.mHasAlpha) {
                super.setAlpha(this.mAlpha);
            }
            if (this.mDrawableContainerState.mHasColorFilter) {
                super.setColorFilter(this.mDrawableContainerState.mColorFilter);
            } else {
                if (this.mDrawableContainerState.mHasTintList) {
                    DrawableCompat.setTintList(super, this.mDrawableContainerState.mTintList);
                }
                if (this.mDrawableContainerState.mHasTintMode) {
                    DrawableCompat.setTintMode(super, this.mDrawableContainerState.mTintMode);
                }
            }
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                super.setAutoMirrored(this.mDrawableContainerState.mAutoMirrored);
            }
            Rect rect = this.mHotspotBounds;
            ...
            super.setCallback(this.mBlockInvalidateCallback.unwrap());
        }
    }
