...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void finish() {
            if (WindowDecorActionBar.this.mActionMode == this) {
                if (!WindowDecorActionBar.checkShowingFlags(WindowDecorActionBar.this.mHiddenByApp, WindowDecorActionBar.this.mHiddenBySystem, false)) {
                    WindowDecorActionBar.this.mDeferredDestroyActionMode = super;
                    WindowDecorActionBar.this.mDeferredModeDestroyCallback = this.mCallback;
                } else {
                    this.mCallback.onDestroyActionMode(super);
                }
                this.mCallback = null;
        ...
        public void invalidate() {
            if (WindowDecorActionBar.this.mActionMode == this) {
                ...
                try {
                    this.mCallback.onPrepareActionMode(super, this.mMenu);
                } finally {
        ...
        public boolean dispatchOnCreate() {
            this.mMenu.stopDispatchingItemsChanged();
            try {
                return this.mCallback.onCreateActionMode(super, this.mMenu);
            } finally {
                this.mMenu.startDispatchingItemsChanged();
            }
        }
        ...
        public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
            ...
            if (callback != null) {
                return callback.onActionItemClicked(super, menuItem);
            }
            return false;
        }
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        public void select() {
            WindowDecorActionBar.this.selectTab(super);
        }
