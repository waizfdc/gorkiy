...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView {
    ...
    public AppCompatTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        AppCompatTextHelper appCompatTextHelper = new AppCompatTextHelper(super);
        this.mTextHelper = appCompatTextHelper;
        appCompatTextHelper.loadFromAttributes(attributeSet, i);
        this.mTextHelper.applyCompoundDrawablesTints();
        this.mTextClassifierHelper = new AppCompatTextClassifierHelper(super);
    }
    ...
    public void setFirstBaselineToTopHeight(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            TextViewCompat.setFirstBaselineToTopHeight(super, i);
        }
    }
    ...
    public void setLastBaselineToBottomHeight(int i) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            TextViewCompat.setLastBaselineToBottomHeight(super, i);
        }
    }

    public int getFirstBaselineToTopHeight() {
        return TextViewCompat.getFirstBaselineToTopHeight(super);
    }

    public int getLastBaselineToBottomHeight() {
        return TextViewCompat.getLastBaselineToBottomHeight(super);
    }

    public void setLineHeight(int i) {
        TextViewCompat.setLineHeight(super, i);
    }

    public void setCustomSelectionActionModeCallback(ActionMode.Callback callback) {
        super.setCustomSelectionActionModeCallback(TextViewCompat.wrapCustomSelectionActionModeCallback(super, callback));
    }

    public PrecomputedTextCompat.Params getTextMetricsParamsCompat() {
        return TextViewCompat.getTextMetricsParams(super);
    }

    public void setTextMetricsParamsCompat(PrecomputedTextCompat.Params params) {
        TextViewCompat.setTextMetricsParams(super, params);
    }

    public void setPrecomputedText(PrecomputedTextCompat precomputedTextCompat) {
        TextViewCompat.setPrecomputedText(super, precomputedTextCompat);
    }
    ...
    private void consumeTextFutureAndSetBlocking() {
        ...
        if (future != null) {
            try {
                ...
                TextViewCompat.setPrecomputedText(super, future.get());
