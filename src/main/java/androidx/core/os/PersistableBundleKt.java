        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (component2 == null) {
                ...
                if (Build.VERSION.SDK_INT >= 22) {
                    ...
                    throw new IllegalArgumentException("Illegal value type boolean for key \"" + component1 + ((char) Typography.quote));
                }
                ...
                if (!String.class.isAssignableFrom(componentType)) {
                    throw new IllegalArgumentException("Illegal value array type " + componentType.getCanonicalName() + " for key \"" + component1 + ((char) Typography.quote));
                ...
                throw new IllegalArgumentException("Illegal value type " + component2.getClass().getCanonicalName() + " for key \"" + component1 + ((char) Typography.quote));
            }
        }
