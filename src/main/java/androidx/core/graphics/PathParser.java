            ...
            while (i4 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        int i7 = i2 + 4;
                        int i8 = i2 + 5;
                        path.cubicTo(fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i5], fArr3[i6], fArr3[i7], fArr3[i8]);
                        f17 = fArr3[i7];
                        float f21 = fArr3[i8];
                        float f22 = fArr3[i5];
                        float f23 = fArr3[i6];
                    ...
                    int i47 = i2 + 5;
                    int i48 = i2 + 6;
                    drawArc(path, f17, f18, fArr3[i47], fArr3[i48], fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != 0.0f, fArr3[i2 + 4] != 0.0f);
                    f = fArr3[i47];
                    f2 = fArr3[i48];
                }
                f14 = f18;
