...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mNestedScrollingParentHelper = new NestedScrollingParentHelper(super);
        if (i == 0) {
    ...
    public void getDescendantRect(View view, Rect rect) {
        ViewGroupUtils.getDescendantRect(super, view, rect);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x011c, code lost:
        if (r0.onMeasureChild(r1, r20, r11, r21, r23, 0) == false) goto L_0x012c;
     */
