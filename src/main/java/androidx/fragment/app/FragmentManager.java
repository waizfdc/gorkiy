...
public abstract class FragmentManager {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: androidx.fragment.app.FragmentManager.moveToState(int, boolean):void
     arg types: [int, int]
     candidates:
      androidx.fragment.app.FragmentManager.moveToState(androidx.fragment.app.Fragment, int):void
      androidx.fragment.app.FragmentManager.moveToState(int, boolean):void */
