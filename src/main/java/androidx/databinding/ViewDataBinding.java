...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    private static void mapBindings(androidx.databinding.DataBindingComponent r17, android.view.View r18, java.lang.Object[] r19, androidx.databinding.ViewDataBinding.IncludedLayouts r20, android.util.SparseIntArray r21, boolean r22) {
        ...
        L_0x004b:
            ...
            int r3 = androidx.databinding.ViewDataBinding.BINDING_NUMBER_START
            int r1 = parseTagInt(r1, r3)
            r3 = r19[r1]
    ...
    private static class WeakPropertyListener extends Observable.OnPropertyChangedCallback implements ObservableReference<Observable> {
        ...
        public void addListener(Observable observable) {
            observable.addOnPropertyChangedCallback(super);
        }

        public void removeListener(Observable observable) {
            observable.removeOnPropertyChangedCallback(super);
        }
    ...
    private static class WeakListListener extends ObservableList.OnListChangedCallback implements ObservableReference<ObservableList> {
        ...
        public void addListener(ObservableList observableList) {
            observableList.addOnListChangedCallback(super);
        }

        public void removeListener(ObservableList observableList) {
            observableList.removeOnListChangedCallback(super);
        }
    ...
    private static class WeakMapListener extends ObservableMap.OnMapChangedCallback implements ObservableReference<ObservableMap> {
        ...
        public void addListener(ObservableMap observableMap) {
            observableMap.addOnMapChangedCallback(super);
        }

        public void removeListener(ObservableMap observableMap) {
            observableMap.removeOnMapChangedCallback(super);
        }
    ...
    private static class LiveDataListener implements Observer, ObservableReference<LiveData<?>> {
        ...
        public /* bridge */ /* synthetic */ void addListener(Object obj) {
            addListener((LiveData<?>) ((LiveData) obj));
        }

        public /* bridge */ /* synthetic */ void removeListener(Object obj) {
            removeListener((LiveData<?>) ((LiveData) obj));
        }
