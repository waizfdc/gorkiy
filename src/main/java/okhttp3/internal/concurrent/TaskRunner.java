...
public final class TaskRunner {
    ...
    private int nextQueueName = AbstractSpiCall.DEFAULT_TIMEOUT;
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     ...
     arg types: [java.util.List<okhttp3.internal.concurrent.TaskQueue>, java.util.List<okhttp3.internal.concurrent.TaskQueue>]
     candidates:
