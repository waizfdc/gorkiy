...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final void readJournal() throws java.io.IOException {
        /*
            ...
            java.lang.String r9 = okhttp3.internal.cache.DiskLruCache.MAGIC     // Catch:{ all -> 0x00be }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r4)     // Catch:{ all -> 0x00be }
            r10 = 1
            r9 = r9 ^ r10
            if (r9 != 0) goto L_0x008e
            java.lang.String r9 = okhttp3.internal.cache.DiskLruCache.VERSION_1     // Catch:{ all -> 0x00be }
    ...
    public final synchronized void rebuildJournal$okhttp() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            java.lang.String r3 = okhttp3.internal.cache.DiskLruCache.MAGIC     // Catch:{ all -> 0x00c5 }
            okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x00c5 }
            r4 = 10
            r3.writeByte(r4)     // Catch:{ all -> 0x00c5 }
            java.lang.String r3 = okhttp3.internal.cache.DiskLruCache.VERSION_1     // Catch:{ all -> 0x00c5 }
            okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x00c5 }
            r3.writeByte(r4)     // Catch:{ all -> 0x00c5 }
        ...
        L_0x0051:
            ...
            java.lang.String r6 = okhttp3.internal.cache.DiskLruCache.DIRTY     // Catch:{ all -> 0x00c5 }
            ...
            goto L_0x0051
        L_0x0079:
            java.lang.String r6 = okhttp3.internal.cache.DiskLruCache.CLEAN     // Catch:{ all -> 0x00c5 }
            okio.BufferedSink r6 = r2.writeUtf8(r6)     // Catch:{ all -> 0x00c5 }
            r6.writeByte(r7)     // Catch:{ all -> 0x00c5 }
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r8) throws java.io.IOException {
        ...
        L_0x003a:
            java.lang.String r2 = okhttp3.internal.cache.DiskLruCache.READ     // Catch:{ all -> 0x0069 }
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r10, long r11) throws java.io.IOException {
        /*
            ...
            long r1 = okhttp3.internal.cache.DiskLruCache.ANY_SEQUENCE_NUMBER     // Catch:{ all -> 0x008c }
        ...
        L_0x0046:
            java.lang.String r12 = okhttp3.internal.cache.DiskLruCache.DIRTY     // Catch:{ all -> 0x008c }
    ...
    public final synchronized void completeEdit$okhttp(okhttp3.internal.cache.DiskLruCache.Editor r9, boolean r10) throws java.io.IOException {
        ...
        L_0x00cd:
            ...
            java.lang.String r10 = okhttp3.internal.cache.DiskLruCache.REMOVE     // Catch:{ all -> 0x013e }
        ...
        L_0x00ea:
            ...
            java.lang.String r1 = okhttp3.internal.cache.DiskLruCache.CLEAN     // Catch:{ all -> 0x013e }
    ...
    private final void validateKey(String str) {
        if (!LEGAL_KEY_PATTERN.matches(str)) {
            throw new IllegalArgumentException(("keys must match regex [a-z0-9_-]{1,120}: \"" + str + ((char) Typography.quote)).toString());
        }
    }
    ...
    public final class Snapshot implements Closeable {
        ...
        /* JADX WARN: Type inference failed for: r6v0, types: [java.util.List<okio.Source>, java.lang.Object, java.util.List<? extends okio.Source>] */
