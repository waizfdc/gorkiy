...
public final class CacheInterceptor implements Interceptor {
    ...
    private final Response cacheWritingResponse(CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, HttpRequest.HEADER_CONTENT_TYPE, null, 2, null), response.body().contentLength(), Okio.buffer(cacheInterceptor$cacheWritingResponse$cacheWritingSource$1))).build();
    }
    ...
    public static final class Companion {
        ...
        private final boolean isEndToEnd(String str) {
            if (StringsKt.equals("Connection", str, true) || StringsKt.equals("Keep-Alive", str, true) || StringsKt.equals("Proxy-Authenticate", str, true) || StringsKt.equals(HttpRequest.HEADER_PROXY_AUTHORIZATION, str, true) || StringsKt.equals("TE", str, true) || StringsKt.equals("Trailers", str, true) || StringsKt.equals("Transfer-Encoding", str, true) || StringsKt.equals("Upgrade", str, true)) {
                return false;
            }
            return true;
        }
        ...
        private final boolean isContentSpecificHeader(String str) {
            if (StringsKt.equals(HttpRequest.HEADER_CONTENT_LENGTH, str, true) || StringsKt.equals(HttpRequest.HEADER_CONTENT_ENCODING, str, true) || StringsKt.equals(HttpRequest.HEADER_CONTENT_TYPE, str, true)) {
                return true;
            }
            return false;
        }
