...
public final class AndroidPlatform extends Platform {
    ...
    public void logCloseableLeak(String str, Object obj) {
        ...
        if (!this.closeGuard.warnIfOpen(obj)) {
            Platform.log$default(super, str, 5, null, 4, null);
        }
    }
