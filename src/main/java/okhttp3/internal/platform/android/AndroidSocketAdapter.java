...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    private final Method setAlpnProtocols = this.sslSocketClass.getMethod("setAlpnProtocols", byte[].class);
    private final Method setHostname = this.sslSocketClass.getMethod("setHostname", String.class);
