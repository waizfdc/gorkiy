...
public final class ConscryptPlatform extends Platform {
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: org.conscrypt.Conscrypt.setUseSessionTickets(javax.net.ssl.SSLSocket, boolean):void
     arg types: [javax.net.ssl.SSLSocket, int]
     candidates:
      org.conscrypt.Conscrypt.setUseSessionTickets(javax.net.ssl.SSLEngine, boolean):void
      org.conscrypt.Conscrypt.setUseSessionTickets(javax.net.ssl.SSLSocket, boolean):void */
    ...
    /* JADX DEBUG: Failed to find minimal casts for resolve overloaded methods, cast all args instead
     method: org.conscrypt.Conscrypt.setUseEngineSocket(javax.net.ssl.SSLSocketFactory, boolean):void
     arg types: [javax.net.ssl.SSLSocketFactory, int]
     candidates:
      org.conscrypt.Conscrypt.setUseEngineSocket(javax.net.ssl.SSLServerSocketFactory, boolean):void
      org.conscrypt.Conscrypt.setUseEngineSocket(javax.net.ssl.SSLSocketFactory, boolean):void */
