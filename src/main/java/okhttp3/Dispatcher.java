...
public final class Dispatcher {
    ...
    public final synchronized List<Call> runningCalls() {
        ...
        unmodifiableList = Collections.unmodifiableList(CollectionsKt.plus(collection, (Iterable) ((List) arrayList)));
        Intrinsics.checkExpressionValueIsNotNull(unmodifiableList, "Collections.unmodifiable…yncCalls.map { it.call })");
        return unmodifiableList;
    }
    ...
    public final ExecutorService m1076deprecated_executorService() {
        return executorService();
    }
