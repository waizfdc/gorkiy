...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\bf\u0018\u0000 \u00062\u00020\u0001:\u0001\u0006J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&\u0002\u0007\n\u0005\bF0\u0001¨\u0006\u0007"}, d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "", "log", "", SettingsJsonConstants.PROMPT_MESSAGE_KEY, "", "Companion", "okhttp-logging-interceptor"}, k = 1, mv = {1, 1, 16})
    /* compiled from: HttpLoggingInterceptor.kt */
    ...
    public final Level m1171deprecated_level() {
        return this.level;
    }
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (z2) {
            ...
            if (body != null) {
                ...
                if (contentType != null && headers.get(HttpRequest.HEADER_CONTENT_TYPE) == null) {
                    this.logger.log("Content-Type: " + contentType);
                }
                if (body.contentLength() != -1 && headers.get(HttpRequest.HEADER_CONTENT_LENGTH) == null) {
        ...
        try {
            ...
            if (z2) {
                ...
                if (!z || !HttpHeaders.promisesBody(proceed)) {
                    ...
                    Long l = null;
                    if (StringsKt.equals(HttpRequest.ENCODING_GZIP, headers2.get(HttpRequest.HEADER_CONTENT_ENCODING), true)) {
    ...
    private final boolean bodyHasUnknownEncoding(Headers headers) {
        ...
        if (str == null || StringsKt.equals(str, "identity", true) || StringsKt.equals(str, HttpRequest.ENCODING_GZIP, true)) {
            return false;
        }
        return true;
    }
