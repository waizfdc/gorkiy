...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1064deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1066deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1065deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
