...
public final class MediaType {
    ...
    public final String m1112deprecated_type() {
        return this.type;
    }
    ...
    public final String m1111deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
                    ...
                    if (group2 != null) {
                        ...
                        while (end < str.length()) {
                            ...
                            if (matcher2.lookingAt()) {
                                ...
                                if (group3 == null || !StringsKt.equals(group3, HttpRequest.PARAM_CHARSET, true)) {
                                    end = matcher2.end();
                                } else {
                                    ...
                                    if (z) {
                                        ...
                                        throw new IllegalArgumentException(("Multiple charsets defined: \"" + str2 + "\" and: \"" + group4 + "\" for: \"" + str + ((char) Typography.quote)).toString());
                                    }
                                }
                            } else {
                        ...
                        return new MediaType(str, lowerCase, lowerCase2, str2, null);
                    }
                    throw new TypeCastException("null cannot be cast to non-null type java.lang.String");
                }
                throw new TypeCastException("null cannot be cast to non-null type java.lang.String");
            }
            throw new IllegalArgumentException(("No subtype found for: \"" + str + ((char) Typography.quote)).toString());
        }
        ...
        public final MediaType m1113deprecated_get(String str) {
        ...
        public final MediaType m1114deprecated_parse(String str) {
            Intrinsics.checkParameterIsNotNull(str, "mediaType");
            return parse(str);
        }
    }
